...
binFileName1 = "CTF-6-BNN-input"
binFileName2 = "CTF-6-BNN-trace"
...
################################################################
plain.seek(16)
for i in range(trace_num*8): #8 = block size (bytes)
...
binFileName1 = "CTF-6-BNN-output"
FileName1 = "output"
plain  = open(binFilePath + '/' + binFileName1+'.bin', 'rb')
fp1    = open(binFilePath + '/' + FileName1 + '.txt', 'w')
plain.seek(16)
for i in range(trace_num*4): #4 = block size (bytes)
